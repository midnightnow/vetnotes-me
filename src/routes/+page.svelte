<script lang="ts">
	...
	// Define specific open-source templates
...
<div class="max-w-6xl mx-auto px-6 py-8">
	<header class="flex justify-between items-center mb-8 border-b border-white/5 pb-6">
		...
		<div class="flex items-center space-x-4">
			...
			<ProButton size="sm">Upgrade to Pro</ProButton>
		</div>
	</header>
				...
				<div class="glass-panel rounded-3xl p-8 flex items-center justify-between">
					<div class="flex items-center gap-6">
						<button on:click={toggleRecording} class="w-16 h-16 rounded-full flex items-center justify-center transition-all {isRecording ? 'bg-red-500 animate-pulse' : 'bg-blue-600 hover:bg-blue-500 shadow-lg shadow-blue-500/20'}">
							...
							{:else}
								<svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
							{/if}
						</button>
						<div>
