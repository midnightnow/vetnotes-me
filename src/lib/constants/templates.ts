export type TemplateId = 'general' | 'surgery' | 'vaccine' | 'dental' | 'emergency' | 'wellness' | 'sick' | 'admission';
...
export const TEMPLATES: Record<TemplateId, Template> = {
    ...
    wellness: {
        ...
        name: 'Wellness',
        icon: '✨',
        prompt: 'Format as a Wellness checkup. Include signalment, diet, and preventatives.'
    },
    sick: {
        id: 'sick',
        name: 'Sick Visit',
        icon: '🤒',
        prompt: 'Format as a sick animal visit. Focus on chief complaint and assessment.'
    },
    dental: {
        id: 'dental',
        name: 'Dental/Oral',
    ...
    admission: {
        ...
        name: 'Admission',
        icon: '🏥',
        prompt: 'Format as a hospital admission note. Include reason for admission and stabilization plan.'
    }
};
